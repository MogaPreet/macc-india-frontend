                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
                            All <span className="bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent">Tablets</span>
                        </h1>
                        <p className="text-gray-500">
                            {filteredProducts.length} Tablets available
                        </p>
                    </motion.div>
                    ...
                    <div className="flex-1 min-w-0 pb-20">
                        {displayedProducts.length > 0 ? (
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-2">No Tablets found</h3>
