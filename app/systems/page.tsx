...
import { Search, SlidersHorizontal, X, Cpu, HardDrive, MemoryStick } from 'lucide-react';
...
export default function SystemsPage() {
    ...
    // Fetch system products from Firebase
    useEffect(() => {
        async function fetchData() {
            try {
                const productsData = await getProductsByType('system');
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
                            All <span className="bg-gradient-to-r from-teal-500 to-emerald-600 bg-clip-text text-transparent">Systems</span>
                        </h1>
                        <p className="text-gray-500">
                            {filteredProducts.length} desktop systems available
                        </p>
                    </motion.div>
                    ...
                    >
                        <div className="relative max-w-2xl">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition-all"
                            />
                            {searchQuery && (
                                <button
                                    onClick={() => {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="flex gap-8">
                    ...
                    <button
                        ...
                        className="lg:hidden fixed bottom-6 left-1/2 -translate-x-1/2 z-40 flex items-center gap-2 bg-gradient-to-r from-teal-500 to-emerald-600 text-white px-6 py-3 rounded-full font-medium shadow-lg shadow-teal-500/25"
                    >
                            ...
                            <>
                                ...
                                >
                                    ...
                                    <div className="mt-6 pt-6 border-t border-gray-200">
                                        <button
                                            onClick={() => setShowMobileFilters(false)}
                                            className="w-full py-3 bg-gradient-to-r from-teal-500 to-emerald-600 text-white rounded-xl font-bold shadow-md shadow-teal-500/20 active:scale-95 transition-all text-center"
                                        >
                    ...
                    <div className="flex-1 min-w-0 pb-20">
                        {displayedProducts.length > 0 ? (
                                    ...
                                    {displayedProducts.map((product, index) => (
                                        ...
                                        >
                                            <Link href={`/product/${product.slug}`} className="block w-full">
                                                <div className="group bg-white rounded-2xl border border-gray-200 overflow-hidden hover:border-teal-300 hover:shadow-lg hover:shadow-teal-500/10 transition-all duration-500 w-full">
                                                    {/* Image */}
                                                    ...
                                                    {/* Content */}
                                                    <div className="p-5">
                                                        <div className="text-xs text-teal-600 font-medium mb-1">{product.brandName}</div>
                                                        <h3 className="text-lg font-bold text-gray-900 mb-3 group-hover:text-teal-600 transition-colors">
                                                            {product.name}
                                                        </h3>

                                                        {/* Specs - No screen/battery for systems */}
                                    ...
                                    >
                                        <AnimatePresence>
                                            {isLoadingMore && (
                                                ...
                                                >
                                                    <div className="w-8 h-8 border-4 border-teal-100 border-t-teal-500 rounded-full animate-spin mb-3"></div>
                                                    <span className="text-sm font-medium text-gray-500 bg-gradient-to-r from-teal-600 to-emerald-600 bg-clip-text text-transparent animate-pulse">
                                                        Discovering powerful systems...
                                                    </span>
                                                </motion.div>
                                            )}
                                        </AnimatePresence>
                            ...
                            >
                                ...
                                <button
                                    onClick={clearAllFilters}
                                    className="px-6 py-3 bg-gradient-to-r from-teal-500 to-emerald-600 text-white rounded-full font-medium hover:from-teal-400 hover:to-emerald-500 transition-all"
                                >
                                    Clear all filters
                                </button>
                            </motion.div>
